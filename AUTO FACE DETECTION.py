...
class FaceRecognitionApp:
    def __init__(self, root):
        ...
        self.name_label = tk.Label(root, text="Enter your name:", font=("Helvetica", 14), fg="white", bg="black")
        self.name_label.pack()

        self.name_entry = tk.Entry(root, font=("Helvetica", 12))
        self.name_entry.pack()

        self.status_label = tk.Label(root, text="", font=("Helvetica", 14), fg="white", bg="black")
